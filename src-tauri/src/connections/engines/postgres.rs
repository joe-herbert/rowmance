...
use crate::connections::types::{
    ...
    ServerAdminCapabilityFlags, ServerStatus, ServerVariable, TableInfo, TriggerInfo, VacuumInfo,
    VarScope, ViewInfo,
};
...
impl DatabaseEngine for PostgresEngine {
    ...
    async fn list_views(
        ...
        crate::connections::postgres::list_views(&self.pool, database).await
    }
    ...
    async fn list_all_indexes(
        ...
        let pairs = crate::connections::postgres::list_all_indexes(&self.pool, database).await?;
        Ok(pairs
            .into_iter()
    ...
    async fn list_all_foreign_keys(
        ...
        let pairs =
            crate::connections::postgres::list_all_foreign_keys(&self.pool, database).await?;
        Ok(pairs
            .into_iter()
    ...
    async fn list_check_constraints(
        ...
        crate::connections::postgres::list_check_constraints(&self.pool, database, table).await
    }
    ...
    async fn list_triggers(
        ...
        crate::connections::postgres::list_triggers(&self.pool, database, table).await
    }
