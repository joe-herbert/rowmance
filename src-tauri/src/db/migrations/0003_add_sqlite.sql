-- Extend the allowed db_type values to include 'sqlite'.
...
CREATE TABLE connection_profiles_new (
    ...
    name            TEXT NOT NULL,
    db_type         TEXT NOT NULL CHECK (db_type IN ('mysql', 'mariadb', 'postgres', 'sqlite')),
    host            TEXT NOT NULL,
    ...
    -- password stays last to match the column order after migration 0002
    password        TEXT
);
