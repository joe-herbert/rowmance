...
<style>
  .vacuum-status { display: flex; flex-direction: column; height: 100%; overflow: hidden; }
  ...
  .error, .empty { padding: 24px; color: var(--color-text-muted); font-size: var(--font-size-sm); text-align: center; }
  ...
  .high-dead { color: var(--color-danger, #e53e3e); font-weight: var(--font-weight-medium); }
</style>
