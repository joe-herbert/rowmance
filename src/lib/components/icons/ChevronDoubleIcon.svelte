<script lang="ts">
  interface Props { direction?: 'left' | 'right'; width?: number | string; height?: number | string; strokeWidth?: number; }
  let { direction = 'left', width = 13, height = 13, strokeWidth = 2 }: Props = $props();
</script>
